...
def convert_xls_to_json(input_file, output_file):
    ...
    jsonname = ['tab1_list','tab1_banner',"tab2_row1_list",'tab2_row2_list','tab2_row3_list','tab3_item1_list','tab3_item2_list']
    jsonnameFile = ['tab2_list','tab2_list',"tab2_list",'tab2_list','tab2_list','tab3_list','tab3_list']
    for i in range(len(jsonname)):
        ...
        # https://youmieyou.oss-cn-shenzhen.aliyuncs.com/haochezhijia/
        # df['imageUrl'] = r"https://youmieyou.oss-cn-shenzhen.aliyuncs.com/haochezhijia/" + jsonname[i] + "/"+ jsonnameFile[i] + "_id_" + df['id'].astype(str) + ".webp"
        df['imageUrl'] = r"file:///android_asset/" + jsonname[i] + "/"+ jsonnameFile[i] + "_id_" + df['id'].astype(str) + ".webp"
        print(df['imageUrl'])
...
if __name__ == "__main__":
    input_file = r"《果园管家》假页面数据表.xlsx"   # Replace with the actual path to your xls file
    ...
    # extract_images_from_excel(input_file, output_folder) #Replace "path/to/input_file.xlsx" with the actual path to your 


    # input_file = "path/to/input_file.xlsx"   # Replace with the actual path to your xlsx file
    # output_folder = "path/to/output_folder"   # Replace with the desired output folder

    # extract_images_from_xlsx(input_file, output_folder)
    # readImage()
