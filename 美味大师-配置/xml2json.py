...
def convert_xls_to_json(input_file, output_file):
    ...
    jsonnameFile = ['tab1_list','tab1_list',"tab2_list",'tab2_list','tab3_list','tab3_list','tab3_list']
...
if __name__ == "__main__":
    input_file = r"meiwei.xlsx"   # Replace with the actual path to your xls file
